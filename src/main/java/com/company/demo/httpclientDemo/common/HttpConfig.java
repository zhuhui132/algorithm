package com.company.demo.httpclientDemo.common;
...
//		}
	...
	public HttpConfig json(String json) {
		...
		map.put(com.arronlong.httpclientutil.common.Utils.ENTITY_JSON, json);
		maps.set(map);
		return this;
	}
...
//		map.put(Utils.ENTITY_MULTIPART+".rmCharset", forceRemoveContentTypeChraset);
		...
		m.put(com.arronlong.httpclientutil.common.Utils.ENTITY_MULTIPART, filePaths);
		m.put(com.arronlong.httpclientutil.common.Utils.ENTITY_MULTIPART+".name", inputName);
